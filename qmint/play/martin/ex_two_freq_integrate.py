import numpy as np
from qmint.play.martin.diff_eqs.two_freq import TwoFreq
from qmint.play.martin.time_integration.sdc_integration import SDCIntegration
...
if __name__ == "__main__":
    ...
    for nt in range(1):
        ...
        u_analytical_fin = two_freq.int_f(u0, dt=T)
        u0 = two_freq.initial_u0()
