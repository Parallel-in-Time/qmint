...
# -*- coding: utf-8 -*-
"""
Specialized :class:`PhiTimeStepper` classes implementing various time-integrators.
"""
import numpy as np

from qmint.steppers.phi import PhiStepper, register

@register
class ForwardEuler(PhiStepper):
    r"""
...
@register
class BackwardEuler(PhiStepper):
    r"""
    ...
    to avoid unnecessary (re-)evaluations of :math:`f(u,t)`.
